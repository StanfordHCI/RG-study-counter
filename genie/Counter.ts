import {GenieClass, DataClass, GenieProperty, int, GenieKey, GenieFunction} from "reactgenie-lib";
...
export class Counter extends DataClass{
    ...
    static Examples = [
        ...
        {
            user_utterance: "Add one more potato",
            example_parsed: 'Counter.All().matching(field: .name, value: "potato").increment()'
        }
    ]
}